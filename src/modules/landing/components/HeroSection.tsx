...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-[42vh] items-center justify-center overflow-hidden px-4 py-14">
      {/* Background gradient */}
      ...
      <div className="relative z-10 text-center">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-purple-700/30 bg-purple-900/20 px-4 py-1.5">
