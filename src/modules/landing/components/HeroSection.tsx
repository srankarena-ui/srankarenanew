...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-[80vh] items-center justify-center overflow-hidden px-4">
      ...
      <div className="absolute left-1/2 top-1/4 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-purple-600/10 blur-[120px]" />
      ...
      <div className="relative z-10 text-center">
        ...
        <h1 className="text-6xl font-black uppercase italic tracking-tighter text-white md:text-8xl">
          {t("heroTitle")}
        </h1>
