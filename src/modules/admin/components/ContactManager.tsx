  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg uppercase italic tracking-tighter text-white">{t("contactTitle")}</h2>
      ...
      <Card>
        <h3 className="mb-4 text-sm uppercase tracking-wider text-white">{t("contactInfo")}</h3>
        <p className="mb-4 text-[9px] font-bold text-gray-600">
          {t("contactSharedBoth")}
        </p>
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <div key={field}>
              <label className="mb-1 block text-[9px] font-bold text-gray-500">{label}</label>
              <input
                value={config[field]}
