    ...
    <div className="space-y-6">
        ...
        {(["es", "en"] as Lang[]).map((l) => (
          <button
            ...
            className={`rounded-lg px-3 py-1.5 text-[10px] transition-colors ${
              lang === l ? "bg-[var(--color-accent)] text-white" : "bg-gray-800 text-gray-400 hover:bg-gray-700"
            }`}
          >
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-gray-800 bg-[#0b0e14] px-3 py-2 text-sm text-gray-200 outline-none focus:border-[var(--color-accent)]"
            />
          </div>
          <div>
            <label className="mb-1 block text-[10px] font-bold text-gray-500">
      ...
      <Card>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            onClick={addCategory}
            className="rounded-lg bg-[var(--color-accent)]/20 px-3 py-1.5 text-[10px] text-purple-300 hover:bg-[var(--color-accent)]/30 transition-colors"
          >
            + Add Category
          </button>
        </div>
              ...
              <div key={cat.id} className="rounded-xl border border-gray-800 bg-[#0b0e14]">
                ...
                <div className="flex items-center gap-3 p-3">
                  <input
                    ...
                    className="w-10 rounded-lg border border-gray-700 bg-[#17191f] px-2 py-1.5 text-center text-sm outline-none focus:border-[var(--color-accent)]"
                    title="Emoji icon"
                  />
                  <input
                    type="text"
                    ...
                    className="flex-1 rounded-xl border border-gray-700 bg-[#17191f] px-3 py-1.5 text-sm text-gray-200 outline-none focus:border-[var(--color-accent)]"
                ...
                {isOpen && (
                  <div className="border-t border-gray-800 p-3 space-y-3">
                        ...
                        <div className="flex items-start gap-2">
                          <div className="flex-1 space-y-2">
                            <input
                              ...
                              className="w-full rounded-lg border border-gray-700 bg-[#0b0e14] px-3 py-1.5 text-xs text-gray-200 outline-none focus:border-[var(--color-accent)]"
                            />
                            <textarea
                              ...
                              placeholder="Answer…"
                              rows={3}
                              className="w-full resize-none rounded-lg border border-gray-700 bg-[#0b0e14] px-3 py-1.5 text-xs text-gray-200 outline-none focus:border-[var(--color-accent)]"
                            />
                          </div>
                          <button
                    ...
                    <button
                      ...
                      className="w-full rounded-xl border border-dashed border-gray-700 py-2 text-[10px] font-bold text-gray-600 hover:border-purple-700 hover:text-[var(--color-accent)] transition-colors"
                    >
                      + Add FAQ Item
                    </button>
                  </div>
